  ...
  const socialLinks = [
    {
      ...
      href: 'https://www.facebook.com/insolva.2025'
    },
    {
      name: 'Instagram',
      icon: (
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div className="lg:col-span-1">
            <div className="flex items-center mb-4">
              ...
              />
              {/* <span className="text-2xl font-bold">Insolva</span> */}
            </div>
            <p className="text-gray-300 mb-6 leading-relaxed">
              Transformamos empresas con metodologías probadas.
              Optimización de procesos, tecnología y resultados sostenibles.
            </p>
          ...
          <div>
            ...
            <div className="space-y-3">
              <div className="flex items-center">
                ...
                <span className="text-gray-300">contacto@insolvagroup.com</span>
              </div>

              <a
                href="https://wa.me/542901641452"
                target="_blank"
              ...
              >
                ...
                <span className="text-gray-300 hover:text-green-400 transition-colors duration-200">+54 9 2901 641-452</span>
              </a>
        ...
        <div className="border-t border-gray-700 mt-8 pt-8">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <p className="text-gray-300 text-sm">
              © {currentYear} Insolva. Todos los derechos reservados.
            </p>
